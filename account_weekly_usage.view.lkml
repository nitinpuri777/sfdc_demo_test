view: account_weekly_usage {
  derived_table: {
    ...
    sql_trigger_value: SELECT DATE_TRUNC('week', DATE_ADD('hour', 3, CONVERT_TIMEZONE('UTC', 'America/Los_Angeles', GETDATE()))) ;;
  ...
  set: detail {
    fields: [account_id, account.name, average_account_health, average_account_health_change, total_usage]
  }

  set: export_set {
    fields: [account_id, weeks_since_signup, event_week, event_month, account_health_score, account_health, total_usage, usage_change_percent, user_count_change, average_user_count_change_percent, average_usage_change_percent, count_of_accounts]
  }
}
